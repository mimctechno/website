...
const service = SERVICES_CONFIG["digital-marketing"];

export function generateStaticParams() {
  const eligibleLocations = getLocationsForService("digital-marketing");
...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  const url = `https://www.mimctechnologies.com/services/digital-marketing/${location.citySlug}/`;
...
export default async function Page(props: Props) {
  ...
  const data = resolveCityServiceData("digital-marketing", location);
