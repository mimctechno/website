...
const service = SERVICES_CONFIG["erp-crm"];

export function generateStaticParams() {
  const eligibleLocations = getLocationsForService("erp-crm");
...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  const url = `https://www.mimctechnologies.com/services/erp-crm/${location.citySlug}/`;
...
export default async function Page(props: Props) {
  ...
  const data = resolveCityServiceData("erp-crm", location);
