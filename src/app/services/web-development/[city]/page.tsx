...
const service = SERVICES_CONFIG["web-development"];

export function generateStaticParams() {
  const eligibleLocations = getLocationsForService("web-development");
...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  const url = `https://www.mimctechnologies.com/services/web-development/${location.citySlug}/`;
...
export default async function Page(props: Props) {
  ...
  const data = resolveCityServiceData("web-development", location);
