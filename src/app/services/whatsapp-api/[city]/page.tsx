...
const service = SERVICES_CONFIG["whatsapp-api"];

export function generateStaticParams() {
  const eligibleLocations = getLocationsForService("whatsapp-api");
...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  const url = `https://www.mimctechnologies.com/services/whatsapp-api/${location.citySlug}/`;
...
export default async function Page(props: Props) {
  ...
  const data = resolveCityServiceData("whatsapp-api", location);
