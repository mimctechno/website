...
export const posts: Post[] = [
  {
    ...
    description: 'Step-by-step guide to integrating WhatsApp Business API with Tally ERP 9 and Tally Prime. Send invoices, payment reminders, and ledger statements automatically.',
    date: '2026-07-15',
    readTime: '8 min read',
  ...
  },
  {
    ...
    title: 'Official vs Unofficial WhatsApp Business API: Which is Right for Your Business?',
    description: 'A complete comparison of Official WhatsApp Business API (Meta BSP) vs Unofficial WhatsApp API solutions. Pros, cons, costs, and which option suits your business volume.',
    date: '2026-07-08',
    readTime: '6 min read',
    category: 'WhatsApp API',
    tags: ['WhatsApp API', 'Official API', 'Meta', 'Business Automation', 'Comparison'],
    sections: [
      {
  ...
  },
  {
    ...
    title: 'What is ERP Software? A Plain-English Guide for Business Owners in 2026',
    description: 'A jargon-free explanation of ERP (Enterprise Resource Planning) software — what it is, how it works, when you need it, and how to choose the right one for your business.',
    date: '2026-07-01',
    readTime: '7 min read',
    category: 'ERP & CRM',
