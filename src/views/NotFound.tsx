  ...
  return (
    <Layout title="404 — Page Not Found">
      <div className="max-w-4xl mx-auto px-6 py-32 text-center relative">
        ...
        <Link href="/" className="inline-flex items-center gap-3 font-[var(--font-cyber-accent)] uppercase tracking-widest cyber-chamfer border-2 border-[var(--color-cyber-accent)] text-[var(--color-cyber-accent)] hover:bg-[var(--color-cyber-accent)] hover:text-black transition-all duration-300 px-8 py-4 font-bold relative z-10">
